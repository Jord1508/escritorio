...
from Vista.ventanaUsuario import *
...
class VentanaPrincipal(QtWidgets.QMainWindow):
    def __init__(self,parent = None):
        ...
        self.btnProductoPage.clicked.connect(self.pageProducto)
        self.btnUsuarioPage.clicked.connect(self.pageUsuario)
        
        self.btnProductoVentana.clicked.connect(self.abrirVentanaProductos)
