...
class Factura(DocumentoVenta):
    ...
    def imprimirDocumentoVenta(self, objCli):
        ...
        print("NOMBRES Y APELLIDOS\t: ", objCli.getNombresCliente(), 
               objCli.getApellidoPaternoCliente(), 
               objCli.getApellidoMaternoCliente())
        ...
        print("--------------------") 
        print("")
        print("ITEM\t", "CÓDIGO DE PRODUCTO\t", "DESCRIPCION\t\t", 
