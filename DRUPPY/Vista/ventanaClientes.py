...
class VentanaClientes(QtWidgets.QMainWindow):
    ...
    def registrar(self):
        if self.valida() == "":
            ...
            QtWidgets.QMessageBox.information(self, "Registrar Cliente", "Error en " + 
                                                self.valida(), QtWidgets.QMessageBox.Ok)
    ...
    def consultar(self):
        ...
        if aCli.tamañoArregloCliente() == 0:
            ...
            if pos == -1:
                QtWidgets.QMessageBox.information(self, "Consultar Cliente", "El DNI ingresado no existe...!!! ", 
    ...
    def eliminar(self):
        if aCli.tamañoArregloCliente() == 0:
            ...
            if fila:
                ...
                QtWidgets.QMessageBox.information(self, "Eliminar Cliente", "Debe seleccionar una fila...!!!", 
                                                          QtWidgets.QMessageBox.Ok)
    def modificar(self):
        if aCli.tamañoArregloCliente() == 0:
    ...
    def grabar(self):
        try:
            ...
            QtWidgets.QMessageBox.information(self, "Modificar Cliente", "Error al modificar cliente...!!!", 
                                              QtWidgets.QMessageBox.Ok)
